...
import '../../Bloc/Article_details_bloc/article_detail_bloc.dart';
          ...
          if (state.bookmarkMessage ==
              ...
              ScaffoldMessenger.of(context)
                .showSnackBar(SnackBar(
                  ...
                  ArticleDetailBloc.bookmarkAddSuccessMessage ? jGreenColor : jRedColor,
                  ...
                  SizedBox(
                    ...
                    child: ShaderMask(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: widget.article.urlImage ?? '',
